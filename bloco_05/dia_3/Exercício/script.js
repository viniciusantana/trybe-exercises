...
/*
Exercício 8:
Implemente uma função que adiciona uma legenda com cor para a tarefa criada
no exercício anterior. Esta função deverá receber como parâmetro uma string ("cor")
...
*/
function makeSub (cor){
    let myTask = document.querySelector('.my-tasks');
    const createDiv = document.createElement('div');
    createDiv.style.backgroundColor = cor;
    createDiv.className = 'task';
    myTask.appendChild(createDiv);
}
makeSub('green');
